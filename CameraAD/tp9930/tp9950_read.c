...
#define TP9930_READ_REG			_IOWR(TP9930_IOC_MAGIC, 1, tp9930_register)
...
int main(int argc, char *argv[])
{
	...
	if (ioctl(fd, TP9930_READ_REG, &dev_reg) != 0)
	{
		printf("ioctl TP9930_READ_REG failed!\n");
	}
	else
	{
